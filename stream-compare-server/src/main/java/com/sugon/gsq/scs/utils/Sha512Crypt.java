 ...
 * com.sugon.util.Sha512Crypt#Sha512_crypt(String, String, int)
...
public final class Sha512Crypt {
    ...
    public static void main(String[] args) {
        boolean hehe = Sha512Crypt.verifyPassword("admin","$6$rounds=10000$a/P/j3HgkDLQkSbo$wgbo2eXa8M3dfzxIcwQDnCHZEC3y84sdanshVroyM6ZcWeX2DXF6R80Rkp9bscd3qLyj8okA7BUTkiwWVoxBo1");
        String password = Sha512Crypt.Sha512_crypt("123","",10000);
