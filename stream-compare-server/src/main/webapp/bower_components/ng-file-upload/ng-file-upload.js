      ...
      if (val !== undefined) {
        ...
        if (angular.isString(val)) {
          ...
          if (angular.isObject(val)) {
            if (val.$$ngfCircularDetection) throw 'ngFileUpload: Circular reference in stream.data. Make sure specified data for Upload.upload() has no circular reference: ' + key;
